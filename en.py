...
def four_elementSaveEn(chr,goal,obst,reso,window):
    #Open the file
    try:
...
def four_elementGuiEn(mainmenu):
    #Close the main menu
    mainmenu.destroy()
    ...
    #Title
    title = ttk.Label(frame1,text="4-ELEMENT STORY", font=("Arial",16,"bold"))
    ...
    #Buttons
    savebutton = ttk.Button(frame3,text="Save",command=lambda:four_elementSaveEn(textchr.get("1.0",tkinter.END),
    ...
    cancelbutton = ttk.Button(frame3,text="Cancel",command=window.destroy)
...
def three_actSaveEn(set,conf,reso,window):
    #Open the file
    try:
        story = io.open("story.txt","w")
    except FileNotFoundError:
...
def three_actGuiEn(mainmenu):
    ...
    #Title
    title = ttk.Label(frame1,text="3-ACT STORY", font=("Arial",16,"bold"))
    title.grid(row=0,column=0,padx=3,pady=3)
    ...
    #Buttons
    savebutton = ttk.Button(frame3,text="Save",command=lambda:three_actSaveEn(textset.get("1.0",tkinter.END),
...
def four_actSaveEn(set,inct,clmx,reso,window):
    #Open the file
    try:
        story = io.open("story.txt","w")
    except FileNotFoundError:
...
def four_actGuiEn(mainmenu):
    ...
    #Title
    title = ttk.Label(frame1,text="4-ACT STORY", font=("Arial",16,"bold"))
    title.grid(row=0,column=0,padx=3,pady=3)
    ...
    #Buttons
    savebutton = ttk.Button(frame3,text="Save",command=lambda:four_actSaveEn(textset.get("1.0",tkinter.END),
...
def seven_actSaveEn(acts, window):
...
def seven_actGuiEn(mainmenu):
    ...
    #Title
    title = ttk.Label(frame1,text="7-ACT STORY", font=("Arial",16,"bold"))
    title.grid(row=0,column=0,padx=3,pady=3)
    ...
    #Buttons
    savebutton = ttk.Button(frame3,text="Save",command=lambda:seven_actSaveEn(texts, window))
    savebutton.grid(row=0,column=0,padx=3,pady=3)
...
def n_actCreateEn(parent, num, labels, texts, scrvs):
...
def n_actSaveEn(acts, size, window):
    #Open the file
    try:
        story = io.open("story.txt","w")
    except FileNotFoundError:
...
def n_actGuiEn(mainmenu):
    ...
    #Title
    title = ttk.Label(frame1,text="N-ACT STORY", font=("Arial",16,"bold"))
    title.grid(row=0,column=0,padx=3,pady=3)
    ...
    n_actCreateEn(frame2, 1, labels, texts, scrvs)

    #Number of Acts Spinbox
    numacts = ttk.Spinbox(frame1,from_=1,to=12,width=20,command=lambda:n_actCreateEn(frame2,int(numacts.get()),labels,texts,scrvs))
    numacts.grid(row=2,column=0,padx=3,pady=3)

    #Buttons
    savebutton = ttk.Button(frame3,text="Save",command=lambda:n_actSaveEn(texts,int(numacts.get()),window))
    savebutton.grid(row=0,column=0,padx=3,pady=3)
...
#Copy Idea English
def copyideaEn(window,button,idea):
...
def showideaGuiEn(mainmenu):
    ...
    #Title
    title = ttk.Label(frame1,text="SHOW IDEA", font=("Arial",16,"bold"))
    title.grid(row=0,column=0,padx=3,pady=3)
    ...
    #Buttons
    okbutton = ttk.Button(frame3,text="OK",command=window.destroy,width=6)
    okbutton.grid(row=0,column=1,padx=3,pady=3)

    copybutton = ttk.Button(frame3,text="Copy to the clipboard",command=lambda:copyideaEn(window,copybutton,idea),width=20)
...
def guiMenuEn(langmenu = None):
    ...
    #Message
    message = ttk.Label(frame1,text="Select an option")
    message.grid(row=2,column=0,padx=3,pady=3)

    #Buttons
    button1 = ttk.Button(frame2,text="4-Element Story", command=lambda:four_elementGuiEn(window))
    button1.grid(row=0,column=0,padx=3,pady=3)

    button2 = ttk.Button(frame2,text="3-Act Story", command=lambda:three_actGuiEn(window))
    button2.grid(row=0,column=1,padx=3,pady=3)

    button3 = ttk.Button(frame2,text="4-Act Story", command=lambda:four_actGuiEn(window))
    button3.grid(row=0,column=2,padx=3,pady=3)

    button4 = ttk.Button(frame3,text="7-Act Story", command=lambda:seven_actGuiEn(window))
    button4.grid(row=0,column=0,padx=3,pady=3)

    button5 = ttk.Button(frame3,text="n-Act Story", command=lambda:n_actGuiEn(window))
    button5.grid(row=0,column=1,padx=3,pady=3)

    button6 = ttk.Button(frame3,text="Show Idea",command=lambda:showideaGuiEn(window))
